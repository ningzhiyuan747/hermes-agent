...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("task-board", "Show the unified operational task board", "Info",
               gateway_only=True),
    CommandDef("control-tower", "Show the control-tower summary across tasks, follow-ups, and operator queue", "Info",
               gateway_only=True, aliases=("tower",)),
    CommandDef("secretary-loop", "Show secretary actions and follow-up suggestions", "Info",
               gateway_only=True, aliases=("secretary",)),
    CommandDef("operator-worklist", "Show the pending operator worklist", "Info",
               gateway_only=True, aliases=("operator",)),
    CommandDef("job-status", "Show active background job status", "Info",
               gateway_only=True, aliases=("jobs",)),
    CommandDef("active-tasks", "Show a compact summary of active tasks", "Info",
               gateway_only=True, aliases=("active",)),
    CommandDef("pending-approvals", "Show tasks currently waiting for approval", "Info",
               gateway_only=True, aliases=("approvals",)),
    CommandDef("blocked-tasks", "Show tasks currently blocked or stalled", "Info",
               gateway_only=True, aliases=("blocked",)),
    CommandDef("recent-failures", "Show recent failed tasks or delivery failures", "Info",
               gateway_only=True, aliases=("failures",)),
    CommandDef("retry-delivery", "Retry delivery for a task without rerunning the executor", "Session",
               gateway_only=True, aliases=("redeliver",), args_hint="<task-id>"),
    CommandDef("follow-up", "Send a low-risk secretary follow-up reminder for a task", "Session",
               gateway_only=True, aliases=("nudge",), args_hint="<task-id>"),
