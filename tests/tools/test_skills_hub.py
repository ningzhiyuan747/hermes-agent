...
class TestCheckForSkillUpdates:
    ...
    def test_bundle_content_hash_accepts_binary_files(self, tmp_path):
        from tools.skills_guard import content_hash
        ...
        bundle = SkillBundle(
            ...
            files={
                ...
                "assets/sample.bin": b"\x00\x01\x02\x03",
            },
            source="official",
        ...
        (skill_dir / "assets" / "sample.bin").write_bytes(b"\x00\x01\x02\x03")
